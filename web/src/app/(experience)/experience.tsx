            ...
            <Container>
                <div className={styles.content}>
                    ...
                    <p className={styles.text}>
                        As a versatile software engineer, I specialise in
                        creating high-quality products that prioritise
                        exceptional user experience and optimal performance. My
                        expertise spans the web, mobile, and desktop
                        architectures, taking ownership of world-class software
                        solutions. Alongside my technical skills, I bring
                        valuable experience in business management and leading
                        the growth of software engineering teams.
                    </p>
